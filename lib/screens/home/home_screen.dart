        ...
        child: ListView(
          children: [
            ...
            ListTile(
              ...
              onTap: () {
                SharedPreferencesHelper.removeData(key: "userId");
                                      ...
                                      child: Column(
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: Text(
                                              HomeCubit.get(context).ourTopPicksList[index].bookName,
                                              maxLines: 2,
                                        ...
                                        children: [
                                          ClipRRect(
                                            ...
                                            child: CachedNetworkImage(
                                              ...
                                              width: 120,
                                              imageUrl:
                                                  HomeCubit.get(context).bestsellersList[index].bookImage,
                                              progressIndicatorBuilder: (context, url, downloadProgress) =>
                                          ...
                                          Padding(
                                            padding: const EdgeInsetsDirectional.symmetric(horizontal: 10),
                                            child: Text(
                                              HomeCubit.get(context).bestsellersList[index].bookName,
                                              maxLines: 2,
                                              textAlign: TextAlign.center,
                                              style: const TextStyle(
                                                fontSize: 18,
                                        ...
                                        children: [
                                          ClipRRect(
                                            ...
                                            child: CachedNetworkImage(
                                              ...
                                              width: 120,
                                              imageUrl:
                                                  HomeCubit.get(context).recentlyViewedList[index].bookImage,
                                              progressIndicatorBuilder: (context, url, downloadProgress) =>
                                                  CircularProgressIndicator(value: downloadProgress.progress),
                                              errorWidget: (context, url, error) => const Icon(Icons.error),
                                            ),
                                          ...
                                          Padding(
                                            padding: const EdgeInsetsDirectional.symmetric(horizontal: 10),
                                            child: Text(
                                              HomeCubit.get(context).recentlyViewedList[index].bookName,
                                              maxLines: 2,
                                              textAlign: TextAlign.center,
                                              style: const TextStyle(
                                                fontSize: 18,
